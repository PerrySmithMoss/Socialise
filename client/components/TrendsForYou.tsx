  ...
  return (
    <div className={classes.root}>
      <Box display="flex" alignItems="center" pl={2} bgcolor="background.paper">
        <Box flexGrow={1}>
          <h3 className="text-base">Trends for you</h3>
        </Box>
        <Box mt={0.5}>
      ...
      <Divider />
      <Box display="flex" pt={1} pb={1} pl={2} bgcolor="background.paper">
        <Box flexGrow={1}>
      ...
      <Divider />
      <Box display="flex"  pt={0.5} pb={1} pl={2} bgcolor="background.paper">
        <Box pb={0.5} flexGrow={1}>
